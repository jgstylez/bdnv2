  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.primary.bg }}>
      ...
      >
        ...
        <HeroSection
          title="Invoices"
          subtitle="Create and manage invoices for your donors and supporters"
        />

        {/* Quick Actions */}
        <View style={{ marginBottom: spacing.xl }}>
          <TouchableOpacity
            onPress={() => router.push("/pages/invoices/create?type=nonprofit")}
            style={{
          ...
          >
            <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
              <View style={{ flex: 1 }}>
                ...
                >
                  Send an invoice to a donor or supporter quickly and easily
                </Text>
              </View>
          ...
          <View style={{ flexDirection: isMobile ? "column" : "row", gap: spacing.md }}>
            <TouchableOpacity
              onPress={() => router.push("/pages/nonprofit/invoices/templates")}
              style={{
                flex: 1,
                ...
                <AdminDataCard
                  ...
                  actions={[
                    ...
                    },
                    {
                      ...
                      icon: "edit",
                      variant: "secondary",
                      onPress: () => router.push(`/pages/invoices/create?id=${invoice.id}&type=nonprofit`),
                    },
                    {
