...
export default function NonprofitProducts() {
    ...
    <View style={{ flex: 1, backgroundColor: "#232323" }}>
      ...
      >
        ...
        <View style={{ marginBottom: 32, flexDirection: "row", gap: 12, justifyContent: "flex-end", flexWrap: "wrap" }}>
          <TouchableOpacity
            onPress={() => router.push("/pages/products/bulk-upload?type=nonprofit")}
            style={{
          ...
          <TouchableOpacity
            onPress={() => router.push("/pages/nonprofit/products/integrations")}
            style={{
              backgroundColor: "#474747",
              paddingHorizontal: 16,
              paddingVertical: 10,
          ...
          <TouchableOpacity
            onPress={() => router.push("/pages/products/create?type=nonprofit")}
            style={{
                ...
                <View style={{ padding: 20 }}>
                  ...
                  >
                    ...
                    <View style={{ flexDirection: "row", gap: 8 }}>
                      <TouchableOpacity
                        onPress={() => router.push(`/pages/products/create?type=nonprofit&id=${product.id}`)}
                        style={{
