/**
 * Shared Invoice Templates Page
 * 
 * Manages invoice templates for both businesses and nonprofits
...
const getMockTemplates = (entityType: "business" | "nonprofit"): InvoiceTemplate[] => {
    ...
    return [
      {
        ...
        description: "Template for monthly recurring donations",
        defaultLineItems: [
          {
        ...
        defaultPaymentTerms: "Net 30",
        defaultNotes: "Thank you for your continued support!",
        isDefault: true,
        createdAt: "2024-01-15T00:00:00Z",
      },
    ];
...
export default function InvoiceTemplatesPage() {
  ...
  const mockTemplates = useMemo(() => getMockTemplates(entityType), [entityType]);
  ...
  const handleUseTemplate = (template: InvoiceTemplate) => {
    ...
    router.push(`/pages/invoices/create?type=${entityType}&templateId=${template.id}`);
  };
        ...
        >
          <View style={{ gap: spacing.md }}>
            <FormInput
              ...
              placeholder={entityType === "nonprofit" ? "e.g., Monthly Donation" : "e.g., Monthly Service Invoice"}
              required
            />
            <FormTextArea
