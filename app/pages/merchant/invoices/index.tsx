/**
 * Merchant Invoices Page (Legacy Route)
 * 
 * Redirects to shared invoices list page with business entity type
...
export default function MerchantInvoices() {
  ...
  useEffect(() => {
    router.replace("/pages/invoices/index?entityType=business");
  }, [router]);
