...
export default function NotificationManagement() {
  ...
  const handleSend = () => {
    ...
    alert(`Push notification sent successfully to ${audienceText} ${sendText}`);
    resetForm();
  };
    ...
    <View style={{ flex: 1, backgroundColor: "#232323" }}>
      ...
      >
        ...
        <View style={{ marginBottom: 32 }}>
          ...
          >
            Send push notifications to users, businesses, or nonprofits. Target specific audiences, schedule sends, or send immediately.
          </Text>
        </View>
        ...
        <View>
          ...
          >
            <MaterialIcons name="notifications" size={48} color="rgba(186, 153, 136, 0.5)" />
            <Text
              style={{
                fontSize: 16,
            ...
            >
              No recent notifications sent. Use the button above to send your first notification.
            </Text>
          </View>
        </View>
